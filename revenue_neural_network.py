...
history = revenue_model.fit(x_train, y_train, epochs=100, verbose=False)
...
y_test = np.sqrt(np.double(test_valid_data["revenue"]))

y_predict = np.power(revenue_model.predict(x_test), 2)
